defmodule TailwindMergeTest do
  ...
  test "break-before" do
    assert tw("break-before-all bg-red-500 break-before-page") ==
  ...
  test "overscroll-x" do
    assert tw("overscroll-x-none bg-red-500 overscroll-x-auto") ==
             "bg-red-500 overscroll-x-auto"
  end

  test "overscroll-y" do
    assert tw("overscroll-y-none bg-red-500 overscroll-y-auto") ==
  ...
  test "text-alignment" do
    assert tw("text-left text-center text-right text-justify text-start text-end") ==
             "text-end"
  end

  test "text-color" do
    assert tw("text-red-500 text-blue-300/30") == "text-blue-300/30"
  end
  ...
  test "bg-size" do
    assert tw("bg-auto bg-cover bg-contain bg-[length:200px_100px]") ==
  ...
  test "gradient-via" do
    assert tw("via-inherit via-current via-black via-red-50 via-indigo-500") ==
             "via-indigo-500"
  end
  ...
  test "outline-style" do
    assert tw("outline outline-dashed outline-dotted outline-double outline-none") ==
             "outline-none"
  end
  ...
  test "ring-color" do
    assert tw("ring-blue-300 ring-red-300 bg-red-100 ring-red-200") ==
